...
@section('content')
    ...
    <div class="container">
        ...
        <div class="navigation-admin mt-2">
            <span class="mr-3">
                <a href="/admin-manage-order-current" class="nav-li activeli">Received</a>
            </span>
            <span class="mr-3">
    ...
    <div class="container my-3">
        <table class="table table-responsive" id="tableDta">
            <thead>
            ...
            <tbody>
                ...
                @if ($user->status=="Received" || $user->status=="STATUS PENDING")
                <tr>
                    <td>
                        {{ $user->created_at }}
                    </td>
