...
<div class="container">
  ...
  <div>
        ...
        <div class="col-md-5 col-12 col-sm-6 pl-3 mt-5 box ">
            <div class="row btn-c" style="border-radius: 15px 15px 0px 0px;">
                <h3 class="mx-3 my-4">
                    TOTAL <br>
                    PAYMENT
                </h3>
            ...
            <div class="row mb-3">
                <div class="navigation-admin mt-2">
                    ...
                    <span class="mr-2">
                        <a href="/adminTranscriptWeek" class="side-nav-li admin-activeli">This Week</a>
                    </span>
                    <span class="mr-2">
                        <a href="/adminTranscriptMonth" class="side-nav-li">This Month</a>
                    </span>
                    <div class="col-md-12" style="display: flex; padding-left:0px;">                            
